...
class SettingsViewModel @Inject constructor(
    ...
    suspend fun exportCsv(profileType: CsvProfileType, outputStream: OutputStream) {
        performOperation {
    ...
    suspend fun importCsv(inputStream: InputStream) {
        performOperation {
            val result = withContext(Dispatchers.IO) {
                importWorkoutCsvUseCase(inputStream)
            }
    ...
    suspend fun importJson(inputStream: InputStream) {
        performOperation {
            val result = withContext(Dispatchers.IO) {
                importWorkoutJsonUseCase(inputStream)
            }
            SettingsEvent.ImportSuccess(result)
        }
    }
